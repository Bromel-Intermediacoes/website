  ...
  <Layout>
    ...
    <div className={"container"}>
      <div className={"content"}>
        ...
        <h3>
          <strong>1. Acordo com os Termos</strong>
        </h3>
        <p>
          1.1 Estes Termos e Condições constituem um contrato juridicamente
          vinculativo feito entre você, pessoalmente ou em nome de uma entidade
          (você), e a Brömel, fazendo negócios como site da Brömel
          (https://www.bromel.com.br), bem como quaisquer aplicativos
          relacionados (o Site).
        </p>
        <p>
          O Site fornece os serviços. Você concorda que, ao acessar o Site e /
          ou os Serviços, você leu, entendeu e concorda em ficar vinculado a
          todos estes Termos e Condições.
        </p>
        <p>
          Se você não concorda com todos esses Termos e Condições, é proibido
          usar o Site e os Serviços e você deve interromper o uso imediatamente.
          Recomendamos que você imprima uma cópia destes Termos e Condições para
          referência futura.
        </p>
        <p>
          1.2 As políticas suplementares estabelecidas na Seção 1.7 abaixo, bem
          como quaisquer termos e condições ou documentos suplementares que
          possam ser publicados no Site periodicamente, são expressamente
          incorporados por referência.
        </p>
        <p>
          1.3 Podemos fazer alterações nesses Termos e Condições a qualquer
          momento. A versão atualizada destes Termos e Condições será indicada
          por uma data "Revisada" atualizada e a versão atualizada entrará em
          vigor assim que estiver acessível. Você é responsável por revisar
          estes Termos e Condições para se manter informado das atualizações.
          Seu uso continuado do Site representa que você aceitou essas
          alterações.
        </p>
        <p>
          1.4 Podemos atualizar ou alterar o Site periodicamente para refletir
          alterações em nossos produtos, nas necessidades de nossos usuários e /
          ou em nossas prioridades de negócios.
        </p>
        <p>
          1.5 Nosso site é direcionado a pessoas residentes no Brasil. As
          informações fornecidas no Site não se destinam à distribuição ou uso
          por qualquer pessoa ou entidade em qualquer jurisdição ou país onde
          essa distribuição ou uso seja contrário à lei ou regulamento ou que
          nos sujeite a qualquer requisito de registro dentro dessa jurisdição
          ou país.
        </p>
        <p>
          1.6 O site é destinado a usuários com pelo menos 18 anos de idade. Se
          você tem menos de 18 anos, não tem permissão para se registrar no Site
          ou usar os Serviços sem a permissão dos pais.
        </p>
        <p>
        ...
        <p>
          <strong>&mdash; </strong>Nossa Política de Privacidade
          https://www.bromel.com.br/privacy, que define os termos nos quais
          processamos quaisquer dados pessoais que coletamos de você ou que você
          nos fornece. Ao usar o Site, você concorda com esse processamento e
          garante que todos os dados fornecidos por você são precisos.
        </p>
